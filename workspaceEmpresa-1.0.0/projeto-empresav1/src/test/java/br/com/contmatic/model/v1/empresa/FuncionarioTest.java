...
public class FuncionarioTest {
	...
	public void deve_permitir_instanciar_funcionario_valido() {
		new Funcionario("Roberto Carlos", "84278571283", retornaEndereco(), retornaContato(), "11-05-2015", retornaSalario(), retornaDepartamento());
	}
	...
	public void nao_deve_aceitar_nome_com_tamanho_inapropriado() {
		...
		assertThat(e.getMessage(), equalTo("Nome do funcionario deve ter tamanho entre " + FUNCIONARIO_NOME_TAMANHO_MIN
				+ " a " + FUNCIONARIO_NOME_TAMANHO_MAX));
	}
	...
	public void nao_deve_aceitar_um_cpf_invalido() {
		...
		assertThat(e.getMessage(), equalTo("O CPF que você inseriu não é válido. Por favor, insira o CPF sem nenhuma formatacao"));
	}
	...
	public void nao_deve_aceitar_data_no_futuro() throws ParseException {
		Date exemplo = new SimpleDateFormat(PADRAO_DATA).parse("15/02/2031");
	...
	public void teste_equals_simetria() {
		Funcionario a = new Funcionario("Ana Maria Clara", "49490297038", retornaEndereco(), retornaContato(), 500.00,
				retornaDepartamento());
		Funcionario b = new Funcionario("Ana Maria Clara", "49490297038", retornaEndereco(), retornaContato(), 750.00,
				retornaDepartamento());
	...
	public void teste_equals_transitividade() {
		Funcionario a = new Funcionario("Ana Carolline", "49490297038", retornaEndereco(), retornaContato(), 500.00,
				retornaDepartamento());
		Funcionario b = new Funcionario("Ana Carolline", "49490297038", retornaEndereco(), retornaContato(), 750.00,
				retornaDepartamento());
		Funcionario c = new Funcionario("Ana Carolline", "49490297038", retornaEndereco(), retornaContato(), 1000.00,
				retornaDepartamento());
	...
	public void teste_equals_funcionarios_com_cpfs_diferentes_nao_devem_ser_iguais() {
		Funcionario funcionario1 = new Funcionario("Ana Vitória Leonardi", "49490297038", retornaEndereco(),
				retornaContato(), 500.00, retornaDepartamento());
