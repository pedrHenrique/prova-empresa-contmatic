...
import br.com.contmatic.empresa.v1.model.contato.TipoDDD;
...
public class TelefoneTest {
	...
	public void novos_telefones_nao_devem_gerar_exception_recebendo_tipos_corretos() {
	...
	@Test(expected = Test.None.class)
	public void setTipoContato_nao_deve_gerar_exception_recebendo_nulo() {
	...
	@Test
	public void setNumeroTelefone_deve_gerar_exception_recebendo_tamanhos_invalidos() {
	...
	@Test
	public void setNumeroTelefone_deve_gerar_exception_recebendo_DDDs_invalidos() {
	...
	@Test
	public void setNumeroTelefone_deve_gerar_exception_recebendo_formatos_invalidos_para_telefone() {
		...
		for (String value : telInvalidos) {
			...
			assertThat(e.getMessage(),
					equalTo("Este formato de telefone passado não pode ser aceito. Por favor, tente novamente."));
		}
	}
	...
	public void setTipoTelefone_deve_gerar_exception_recebendo_tipos_incorretos_sobre_telefone() {
		...
		assertThat(listaExceptions.get(0).getMessage(), equalTo("O Tipo de telefone inserido não condiz com o informado!"));
		assertThat(listaExceptions.get(1).getMessage(), equalTo("O Tipo de telefone inserido não condiz com o informado!"));
	}
	...
	@Test
	public void tipoTelefone_deve_ser_alterado_se_numeroTelefone_for_alterado() {
