 ...
 * <ul>
 * <li>Verificar se o CPF informado é válido:
 * {@link Documentos#cpfValido(String)};</li>
 * <li>Gerar um CPF aleatório válido: {@link Documentos#cpfAleatorio()};</li>
 * <li>Verificar se o CNPJ informado é válido:
 * {@link Documentos#cnpjValido(String)};</li>
...
public final class Documentos {
	 ...
	 * 
	 * @return <code>true</code> se o CNPJ informado for válido e <code>false</code>
	 *         caso contrário.
	 * 
	 * @see Documentos#cpfValido(String)
	 * @see Documentos#cpfAleatorio()
	 ...
	 * 
	 * @return <code>true</code> se o CPF informado for válido e <code>false</code>
	 *         caso contrário.
	 * 
	 * @see Documentos#cpfAleatorio()
	 * @see Documentos#cnpjValido(String)
